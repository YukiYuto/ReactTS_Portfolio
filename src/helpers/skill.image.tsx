...
import sqlserver from "assets/svg/skills/sqlserverlogo.svg";
...
// Helper function with better type safety
export const getSkillImage = (skillName: SkillName): string | undefined => {
  return skillsImage(skillName);
};
