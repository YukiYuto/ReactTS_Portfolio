...
export const APP_DATA = {
  YOUTUBE_URL: "https://www.youtube.com/@Yuki-Q1003",
  TIKTOK_URL: "https://www.tiktok.com/@hoidanit",
  UDEMY_URL: "https://www.udemy.com/user/eric-7039/",
  FACEBOOK_URL: "https://www.facebook.com/pham.quan.7320",
  CV_URL:
    "https://drive.google.com/file/d/1UJdKicx_iv7-qxoSBhrskbLJZuHkEVvh/view?usp=drive_link",
};
...
export const PROJECTS = [
  {
    ...
    title: "React TS Basic Portfolio",
    description: "A basic portfolio website built with React and TypeScript.",
    githubLink:
  ...
  },
  {
    ...
    title: "C# ASP.NET Core REST API",
    description:
      "A Skincare booking system building RESTful APIs using C# and ASP.NET Core.",
    githubLink: "https://github.com/YukiYuto/skincare-booking-system-SP25-SWP",
    demoLink:
