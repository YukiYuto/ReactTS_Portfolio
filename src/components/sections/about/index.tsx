...
const About = () => {
  ...
  return (
    <>
      <Row>
        <Col md={6} xs={12}>
          <h3 className="text-center mb-md-5 mb-2">
            {t("about.title")}{" "}
            <span className="brand-red">{t("about.subtitle")}</span>{" "}
          </h3>
          <div>
            <div>
              <p> {t("about.body_1")}</p>
          ...
          <div>
            <p>{t("about.body_3")}</p>
            <ul>
              <li>{t("about.subbody_3-1")}</li>
              <li>{t("about.subbody_3-2")}</li>
              <li>{t("about.subbody_3-3")}</li>
            </ul>
          </div>
          <div>
      ...
      <Row>
        ...
        <Col md={6} xs={12} className="mt-md-5 mt-3">
          <div className="d-flex flex-column align-items-center gap-3">
            <div>
              <h4 className="text-center brand-red">{t("education.title")}</h4>
            </div>
            <div>
                ...
                <div className="p-3 relative">
                  <div className="experience-container">
                    ...
                    <div className="details">
                      ...
                      <div className="info">
                        <p className="title">{t("education.degree")}</p>
      ...
      <Row>
        <Col md={6} xs={12} className=" mt-md-5 mt-3">
          <h3 className="mb-md-5 mb-2">{t("footer.find")}</h3>
          <SocialMedia
        ...
        >
          ...
          />
          <h4 className="text-center">{t("footer.contact")}</h4>
        </Col>
      </Row>
